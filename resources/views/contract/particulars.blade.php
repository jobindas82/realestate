        ...
        <table class="table table-hover" id="contract-items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ Form::number('ContractItems['.$i.'][amount]', $each->amount, [ 'class' => 'form-control', 'required', 'id' => 'ContractItems_'.$i.'_amount', 'min' => 0, 'max' => 999999999999999, 'onKeyup' => 'calculate();']) }}</td>
                    <td>
