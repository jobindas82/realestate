    ...
    <div class="row clearfix">
        <div class="col-sm-4">
            <div class="form-group form-float">
                <div class="form-line">
                    {{ Form::select('tenant_id', $model->exists ? [ $model->tenant_id => $model->tenant->name ] : [], $model->tenant_id, [ 'class' => 'form-control show-tick ajax-drop', 'id' => 'tenant-drop-contract', 'required']) }}
