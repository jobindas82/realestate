        ...
        <table class="table table-hover" id="contract-items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ Form::number('ContractItems['.$i.'][amount]', $each->amount, [ 'class' => 'form-control', 'required', 'id' => 'ContractItems_'.$i.'_amount', 'onKeyup' => 'calculate();' , 'onBlur' => 'round_field(this.id)']) }}</td>
                    <td>
